...
| O eixo editorial deixou de ser acidente e virou motor. | A pergunta principal foi **preparada e escrita** — *"Como a pressão estranha do mundo transforma a gente?"* `[E2 07:34]` — e o episódio inteiro gira em torno dela: Hassum, Superman, Batman, Kafka. | Nos pilotos vocês acharam o eixo sem perceber; agora vocês partiram dele de propósito. |
| Os vícios que dá para medir caíram. | *"Tá ligado"* foi de **116× em 87 min** (1,33/min) para **34× em 76 min** (0,45/min). O *"acho que sim"* não desabou: 8× no arquivo todo, sem o loop dos pilotos, e vocês passaram a perguntar *"por quê / fale quais partes"* `[E2 52:37]`. | As notas do piloto sobre vício de fala e concordância pegaram. |
| O ritmo **não** desacelerou e o tempo estourou. | 174 palavras/min no total, mediana de **180 ppm** por janela — igual/acima do P1 (176) e longe do alvo (~150). Só **1min 12s** de pausa longa em 76 min. Duração **76min 30s**, acima do teto de 60, com um fim-falso aos `[E2 59:29]` ignorado. | O *low vibe* — desacelerar, deixar ar, parar aos 60 — é o que ainda não aconteceu. |
| A melhor parte foi uma história; a pior foi quando a pauta secou. | Pico de **235 ppm** na história do sofá do pai do André `[E2 35:16–40:51]`; vale de **108 ppm** quando o assunto *"não rendeu"* e viraram meta-conversa sobre o próprio podcast `[E2 48:00–54:00]`. | Seguir a história (como o guia manda) funcionou; depender da pauta travou. |
...
| Palavras | 10.739 + 3.755 | **13.323** |
| Fala / silêncio | 87% / 78% | **89%** |
| Densidade total | 176 / 144 ppm | **174 ppm** (mediana por janela: **180**) |
| Pausa longa (>3s) | 1min 02s / 1min 28s | **1min 12s** (13 pausas) |

**Objeto:** o filme *Amor Sem Medidas* (Leandro Hassum). Um dos dois **assistiu e anotou** —
*"Eu anotei aqui. Eu fiz o meu trabalho."* `[E2 06:35]`; o outro **não viu** — *"A gente
...
Ressalvas de transcrição estão em §6. As principais: o áudio segue **mono** (não há como saber
quem falou), e há três trechos em que o Whisper **alucinou sobre quase-silêncio** — o mais
visível é uma sequência de *"É…"* repetida entre `[E2 75:04]` e `[E2 75:59]`, que **não é fala
real**, é o modelo preenchendo os 14s de pausa do fim.
...
| **Pergunta principal preparada** | ✅ **Aplicado** | Escrita antes: *"Como a pressão estranha do mundo transforma a gente?"* `[E2 07:34]`. É uma pergunta sem resposta certa e que toca o eixo — exatamente o pedido do guia. |
| **Objeto consumido de verdade pelos dois** | ⚠️ **Meio** | Um assistiu e anotou `[E2 06:35]`; o outro não viu `[E2 05:58]`. A preparação melhorou de um lado; a regra "os dois consomem" segue quebrada. |
| **Ritmo ~150 ppm e deixar o ar existir** | ❌ **Não aplicado** | 180 ppm de mediana (acima do P1), 89% de fala, só 1min 12s de pausa longa. Continua sem respiro — o número que o piloto já apontava como faca de dois gumes. |
| **Não desabar em "acho que sim"; descer ao motivo** | ✅ **Melhorou** | 8 ocorrências no episódio todo, sem o loop do `[P1 42:16]`. E vocês perguntam o motivo: *"Cara, eu concordo em parte." — "Fale quais partes."* `[E2 52:37]`. |
...
| **Teto de 60 minutos; encerrar com assunto vivo** | ❌ **Não aplicado** | 76min 30s. Houve um fim-falso — *"Vamos encerrar"* `[E2 59:29]` — e seguiram +17 min. O fim veio por sono, não por escolha: *"tá com sono, mano"* `[E2 75:59]`. |
| **Despedida fixa** *("Isso foi Áudio Sem Autoestima. Até a próxima.")* | ❌ **Não aplicado** | A frase não aparece. Encerraram improvisando: *"Vamos encerrar? — Vamos. — Fecha aí, velho."* `[E2 76:18]`. Menos constrangido que o *"como é que encerra o podcast?"* `[P2 25:28]`, mas ainda improvisado. |
...
| **Fazer a conexão em voz alta** | ⚠️ **Meio** | Acertaram um callback ao piloto — *"essa foi discutida no podcast passado, que a gente falou do Mojica"* `[E2 19:06]`. Mas **perderam** a conexão mais óbvia do episódio: a barata de Kafka `[E2 60:09]` é o eixo em estado puro e virou piada de pronúncia (§4). |
...
|---|---|---|
| `[E2 07:34–11:00]` | O filme do Hassum | A pressão do mundo (ser baixinho, ser julgado) transforma a pessoa |
...
| `[E2 60:09]` | Kafka | Virar um inseto: a metamorfose de quem não cabe |
...
- **André — o significado:** sobe para o que a coisa representa. Traz a pergunta do eixo
  `[E2 07:34]`, defende que o Hassum foi *"corrompido, talvez positivamente"* `[E2 16:34]`, lê o
...
|---|---|---|
| `[E2 35:16–40:51]` | **A história do sofá do pai do André**: a intimação no correio, o funcionário estressado, o reencontro em que viram amigos porque as duas vidas se espelham | É o trecho mais denso do episódio (235 ppm) e o mais bem contado. Um causo com arco completo, exatamente o "desvio que ganhou força" que o guia manda deixar acontecer. |
...
| `[E2 16:43]` | *"Se ele fosse mais Leandro e menos Leandrinho"* | Uma frase que é a tese do programa inteiro, dita de passagem. Corte curto pronto. |
...
| `[E2 19:06]` | Callback ao piloto: *"isso foi discutido no podcast passado, quando a gente falou do Mojica"* | Começa a costurar uma continuidade entre episódios. |
...
Este é o item mais importante que **não** mudou. A mediana subiu para 180 ppm (era 176 no P1),
a fala é 89% do arquivo e há só 1min 12s de pausa longa em 76 min. O piloto já dizia: não existe
...
cansado até o *"tá com sono, mano"* `[E2 75:59]`. O episódio passou dos 60 min do guia (76min
...
barata igual o Kafka"* `[E2 60:09]`. **A Metamorfose é o eixo do programa em estado puro** — um
...
O vale de energia do episódio (108–114 ppm, `[E2 48:00–54:00]`) começou quando o assunto
...
- **Transcrição:** Whisper large-v3, mas rodado em modo mais leve (`beam_size=1`, sem
  timestamps por palavra) para não travar a GPU. A qualidade do texto continua alta (idioma pt,
  prob. 1,0; só 0,3% de segmentos de baixa confiança), mas nomes e grafias podem sair errados —
  confira *Amor Sem Medidas* e os nomes próprios antes de citar em público.
- **Alucinações sobre silêncio:** há três trechos em que o modelo preencheu quase-silêncio com
  repetição. O mais longo é a sequência de *"É…"* entre `[E2 75:04]` e `[E2 75:59]` — **não é
  fala**, é artefato sobre a pausa de 14s do fim. O *"não precisa"* repetido em `[E2 11:02–11:08]`
  é real (vocês repetiram mesmo).
...
- **Juízo editorial:** chamar a história do sofá de melhor trecho, ou a barata de Kafka de
  conexão perdida, é leitura humana. As janelas de 235 e 108 ppm não contradizem essas leituras,
...
- Baixar o ritmo dos 180 ppm rumo aos ~150 e **deixar o silêncio existir**.
